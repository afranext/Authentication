...
<form wire:submit.prevent="loginByPassword" class="afc-wizard__form">
    ...
    <div class="afc-wizard__form__item">
        <button class="" type="submit">ورود
        </button>
    </div>
</form>

<div class="afc-wizard__form__subtitle">
    <button class="" wire:click="loginWithToken" type="button"> ورود با رمز یکبار مصرف ></button>
    <button class="" wire:click="forgotPassword" type="button">فراموشی رمز عبور ></button>
</div>
